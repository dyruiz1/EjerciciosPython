#un programa que reciba y sume numeros mientras sean positivos
# def main():
...
#     main()
    ...
    # codificar un programa que presente un menu de 4 opciones y reciba un numero natural para realizar las siguientes operaciones 
    # 0: salida
